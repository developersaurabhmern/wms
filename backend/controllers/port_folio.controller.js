                            ...
                            if (data1.length != 0 || data2.length != 0 || data3.length != 0) {
                                ...
                                const secondquery = async function (rta, scheme, pan, folio, name) {
                                    if (rta === "CAMS") {
                                        ...
                                        datascheme.push({folio:folio,scheme:scheme});
                                    ...
                                    console.log(dataarr[i])
                                       //    if (datascheme.indexOf(dataarr[i].FOLIO) != -1) {
                                            // if (dataarr[i].FOLIO === datascheme[datascheme.indexOf(dataarr[i].FOLIO)]) {
                                                console.log(datascheme[j].folio)
                                           if(datascheme[j].folio === dataarr[i].FOLIO && datascheme[j].scheme === dataarr[i].SCHEME){
                                                ...
                                                if (dataarr[i].NATURE != 'Switch Out' && dataarr[i].UNITS != 0) {
                                                    // console.log("nature ,folio",dataarr[i].NATURE,dataarr[i].FOLIO)
                                                    ...
                                                    console.log("arrunitif=",arrunit,dataarr[i].FOLIO)
                                                    ...
                                                    console.log("unit=",dataarr[i].UNITS)
                                                    unit = "-" + dataarr[i].UNITS
                                                    amount = "-" + dataarr[i].AMOUNT
                                                    if (temp4 != "") {
                                                    ...
                                                    console.log("arrunit=",arrunit,dataarr[i].FOLIO)
